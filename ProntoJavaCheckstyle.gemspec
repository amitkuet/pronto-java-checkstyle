...
Gem::Specification.new do |spec|
  spec.name          = "ProntoJavaCheckstyle"
  spec.version       = ProntoJavaCheckstyle::VERSION
  spec.authors       = ["Amit Mondal"]
  spec.email         = ["amit.mondal@welldev.io"]

  spec.summary       = "Pronto runner for Java"
  spec.license       = "MIT"
  spec.homepage = "https://github.com/amitkuet/pronto-java-checkstyle";
